...
1. should have units
1. A legend if there are multiple lines
1. They should have a description below of what the figure is
...
Gridlines obscure the point because we already have the numbers
The axes are skewing the visualization
THe graph isn't really helpful because all the number of work hours are very similar
...
The axis starts at 0 but shouldn't because it hides the variation in the data.
It also would be useful to have the years
