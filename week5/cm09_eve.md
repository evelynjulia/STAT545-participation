...
##    label         x      y
##    <chr>     <dbl>  <dbl>
##  1 Sample A -0.162  0.518
##  2 Sample A -0.403 -0.663
##  3 Sample A -0.933 -1.82 
##  4 Sample A -0.628 -0.818
##  5 Sample A  1.32   0.464
##  6 Sample A -2.14  -4.40 
##  7 Sample A  0.963  0.683
##  8 Sample A -0.379 -0.113
##  9 Sample A  0.722  0.348
## 10 Sample A -0.341 -2.21 
## # … with 90 more rows
```
...
##   <chr>  <chr> <dbl>         <dbl>         <dbl>
## 1 Alex   a         1        0.805         0.206 
## 2 Alex   a         2        0.0613        0.674 
## 3 Alex   a         3        0.769         0.0168
## 4 Robert b         1        0.692         0.437 
## 5 Robert b         2        0.478         0.764 
## 6 Robert b         3       NA            NA     
## 7 Sam    a         1        0.830         0.767 
## 8 Sam    a         2       NA            NA     
## 9 Sam    a         3       NA            NA
```
